...
const CustomerSearch = () => {
  ...
  return (
    <div className="relative h-[calc(100vh-var(--bottom-bar-height)-var(--header-height))] w-full overflow-hidden">
      {!isLoading && <InteractiveMap />}

      <div
        className={`absolute bottom-0 left-0 right-0 z-10 bg-white transition-transform duration-200 ease-in-out ${
